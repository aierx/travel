...
onMounted(async () => {
    ...
    tableData.value = await axios.post("/tour/scenery/list", {attr2: "scenery"}).then(e => e.data)
})
const tableData = ref([])
...
<template>
        <div v-if="isShowTable">
            ...
            <el-row style="margin-top: 20px">
                <el-table :data="filterTableData" style="width: 100%" @selectionChange="aaa" height="calc(100vh - 160px)">
                    <el-table-column type="selection" width="55"/>
                    <el-table-column label="名称" prop="name" width="180"/>
                    <el-table-column label="类型" prop="type" width="100"/>
                    <el-table-column label="手机号" prop="phone" width="140"/>
                    <el-table-column label="评级" prop="grade" width="80"/>
    ...
    <el-row v-if="!isShowTable">
        <create-scenery @onBack="onBackFun" :form="form"/>
    </el-row>
</template>
